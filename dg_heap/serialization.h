...
namespace dg_heap::compact_serializer::constants{

    static constexpr auto endianness    = std::endian::little;
}

namespace dg_heap::compact_serializer::types{

    using hash_type     = uint64_t; 
    using size_type     = uint64_t;
}

namespace dg_heap::compact_serializer::runtime_exception{

    struct CorruptedError: std::exception{}; 
}

namespace dg_heap::compact_serializer::types_space{
    ...
    template <class T>
    struct containee_type: containee_or_empty<T>{};
...
namespace dg_heap::compact_serializer::utility{
...
namespace dg_heap::compact_serializer::archive{
...
namespace dg_heap::compact_serializer::core{
...
namespace dg_heap::compact_serializer{
