#ifndef __CRON_SUBSYSTEM_IMPLEMENTATION_CRON_SUBSYSTEM_IMPLEMENTATION_H__
#define __CRON_SUBSYSTEM_IMPLEMENTATION_CRON_SUBSYSTEM_IMPLEMENTATION_H__
...
#include <cron_subsystem/updatable_interface.h>

namespace cron_subsystem::implementation
{
