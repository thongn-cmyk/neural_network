#ifndef __MATRIX_PROJECTION_CLIENT_MODEL_H__
#define __MATRIX_PROJECTION_CLIENT_MODEL_H__
...
namespace matrix_projection_client
{
    ...
    {
        std::expected<std::string, matrix_projection_client::local_exception_t> response;
    ...
    {
        std::expected<uint64_t, matrix_projection_client::local_exception_t> result;
        std::string err_verbal_description;
    ...
    {
        matrix_projection_client::local_exception_t result;
        std::string err_verbal_description;
    ...
    {
        std::expected<matrix_serializer::GenericMatrix, matrix_projection_client::local_exception_t> result;
        std::string err_verbal_description;
