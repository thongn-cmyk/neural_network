#ifndef __DATA_LOADER_CONFIG_BUILDER_FILE_LOADER_CONFIG_BUILDER_H__
#define __DATA_LOADER_CONFIG_BUILDER_FILE_LOADER_CONFIG_BUILDER_H__
...
namespace data_loader::config_builder
{
    class FileLoaderConfigBuilder
    {
        ...
        public:
            ...
            {
                this->get_file_loader_config_builder()
        ...
        private:
            ...
            auto get_file_loader_config_builder() -> data_loader::source::file_source::FileLoaderConfigBuilder&
            {
