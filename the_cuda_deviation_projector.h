#ifndef __THE_CUDA_DEVIATION_PROJECTOR_H__
#define __THE_CUDA_DEVIATION_PROJECTOR_H__
...
namespace the_cuda_deviation_projector
{
    ...
    class ImmutableMemoryCacheInterface
    {
        public:
            ...
            virtual auto cache_n_acquire_memory(const std::shared_ptr<void>& immutable_reference, std::string_view mem) -> MemoryReference = 0;
    ...
    class CudaImmutableMemoryCache: public virtual ImmutableMemoryCacheInterface
    {
        ...
        public:
            ...
            CudaImmutableMemoryCache(size_t auto_evict_memory_threshold): reference_map(),
                                                                          heap_node_vec(),
            ...
            auto cache_n_acquire_memory(const std::shared_ptr<void>& immutable_reference, std::string_view mem_view) -> MemoryReference
            {
                ...
                std::shared_ptr<void> cu_mem = cu_x::make_cuda_buffer_from_host_view(mem_view);
        ...
        private:
            ...
            auto internal_evict_memory(uintptr_t reference_addr) noexcept -> bool
            {
                ...
                {
                    this->update_heap_node_at(positional_idx);
                }
    ...
    class DistributedCudaImmutableMemoryCache: public virtual ImmutableMemoryCacheInterface
    {
        ...
        public:
            ...
            DistributedCudaImmutableMemoryCache(size_t auto_evict_memory_threshold,
                                                size_t concurrency_sz)
            {
                ...
                {
                    this->base_vec[i] = std::make_unique<CudaImmutableMemoryCache>(auto_evict_memory_threshold);
                }

                this->randomizer    = std::bind(std::uniform_int_distribution<size_t>(), std::mt19937_64{static_cast<uint32_t>(std::chrono::system_clock::now().time_since_epoch().count())});
            }
