...
namespace taylor_matrix::host_matrix::tensor_process_group_operation
{
                                                            ...
                                                            const Allocator& allocator = Allocator()) -> std::shared_ptr<tensor_model::ProcessGroup>
    {
...

        {
            ...
            std::shared_ptr<tensor_model::ProcessGroup> avg_arr[]{arg, xx};
            rs0 = avg(avg_arr, 2u, allocator);
        }

        std::shared_ptr<tensor_model::ProcessGroup> rs1 = {};

        {
            tensor_model::ProcessGroup sub_xx{};
            ...
            std::shared_ptr<tensor_model::ProcessGroup> sub_xx_sp = std::allocate_shared<tensor_model::ProcessGroup>(allocator, sub_xx);
            std::shared_ptr<tensor_model::ProcessGroup> avg_arr[]{rs0, sub_xx_sp};
