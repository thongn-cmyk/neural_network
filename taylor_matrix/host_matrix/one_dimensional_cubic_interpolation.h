...
{
    consteval auto get_cubic_interpolated_base_projection_size() -> size_t
    {
        return 4u;
    }
    ...
    constexpr auto get_cubic_exp_interpolated_projection_size() -> size_t
    {
        ...
        return get_cubic_interpolated_base_projection_size() * ExponentialQuantizationMachine{}.quantization_size();
    }

    template <class FloatType, class PromotedFloatType = FloatType, bool HasBoundCheck = true>
                                                  ...
                                                  const std::integral_constant<bool, HasBoundCheck>& bound_check = std::integral_constant<bool, HasBoundCheck>{}) -> PromotedFloatType
    {
        ...
        constexpr size_t BASE_SZ        = get_cubic_interpolated_base_projection_size();
