#ifndef __DG_DATASTRUCTURE_H__
#define __DG_DATASTRUCTURE_H__
    ...
    class simple_pow2_cyclic_queue{
        ...
        public:
            ...
            constexpr auto push_back(ValueLike&& value) noexcept -> exception_t{
                ...
                if (this->sz == this->cap){
                    return common_exception::QUEUE_FULL;
                }
...
namespace datastructure::unordered_map_variants{
    ...
    class cyclic_unordered_node_map{
        ...
        private:
            ...
            datastructure::queue::pow2_cyclic_queue<Node<HasStructureReordering, Key, Mapped, VirtualAddrType>, typename std::allocator_traits<Allocator>::template rebind_alloc<Node<HasStructureReordering, Key, Mapped, VirtualAddrType>>> virtual_storage_vec;
            std::vector<VirtualAddrType, typename std::allocator_traits<Allocator>::template rebind_alloc<VirtualAddrType>> bucket_vec;
    ...
    class cyclic_unordered_node_set{
        ...
        private:
            ...
            datastructure::queue::pow2_cyclic_queue<UnorderedSetNode<KeyType, VirtualAddrType>, typename std::allocator_traits<Allocator>::template rebind_alloc<UnorderedSetNode<KeyType, VirtualAddrType>>> virtual_storage_vec;
            std::vector<VirtualAddrType, typename std::allocator_traits<Allocator>::template rebind_alloc<VirtualAddrType>> bucket_vec;
            size_t virtual_addr_offset;
            Hasher _hasher;
            Pred pred;
...
namespace std{
    ...
    template <class ...Args>
    constexpr void swap(datastructure::unordered_map_variants::unordered_node_map<Args...>& lhs,
                        datastructure::unordered_map_variants::unordered_node_map<Args...>& rhs) noexcept(noexcept(std::declval<datastructure::unordered_map_variants::unordered_node_map<Args...>&>().swap(std::declval<datastructure::unordered_map_variants::unordered_node_map<Args...>&>()))){

        lhs.swap(rhs);
    }

    template <class ...Args, class Pred>
    constexpr void erase_if(datastructure::unordered_map_variants::unordered_node_map<Args...>& umap,
                            Pred pred){
    ...
    template <class ...Args>
    constexpr void swap(datastructure::unordered_map_variants::cyclic_unordered_node_map<Args...>& lhs,
                        datastructure::unordered_map_variants::cyclic_unordered_node_map<Args...>& rhs) noexcept(noexcept(std::declval<datastructure::unordered_map_variants::cyclic_unordered_node_map<Args...>&>().swap(std::declval<datastructure::unordered_map_variants::cyclic_unordered_node_map<Args...>&>()))){

        lhs.swap(rhs);
    }

    template <class ...Args>
    constexpr void swap(datastructure::unordered_map_variants::unordered_node_set<Args...>& lhs,
                        datastructure::unordered_map_variants::unordered_node_set<Args...>& rhs) noexcept(noexcept(std::declval<datastructure::unordered_map_variants::unordered_node_set<Args...>&>().swap(std::declval<datastructure::unordered_map_variants::unordered_node_set<Args...>&>()))){

        lhs.swap(rhs);
    }

    template <class ...Args, class Pred>
    constexpr void erase_if(datastructure::unordered_map_variants::unordered_node_set<Args...>& uset,
                            Pred pred){
    ...
    template <class ...Args>
    constexpr void swap(datastructure::unordered_map_variants::cyclic_unordered_node_set<Args...>& lhs,
                        datastructure::unordered_map_variants::cyclic_unordered_node_set<Args...>& rhs) noexcept(noexcept(std::declval<datastructure::unordered_map_variants::cyclic_unordered_node_set<Args...>&>().swap(std::declval<datastructure::unordered_map_variants::cyclic_unordered_node_set<Args...>&>()))){
