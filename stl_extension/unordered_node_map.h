#ifndef __NETWORK_DATASTRUCTURE_H__
#define __NETWORK_DATASTRUCTURE_H__
...
namespace unordered_map_variants{
    ...
    class unordered_set_node_external_iterator{
        ...
        public:
            ...
            template <class OtherBidirIterator, std::enable_if_t<std::conjunction_v<std::negation<std::is_same<BidirIterator, OtherBidirIterator>>,
                                                                                    std::is_convertible<OtherBidirIterator, BidirIterator>>, bool> = true>
