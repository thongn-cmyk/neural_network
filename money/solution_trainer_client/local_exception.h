#ifndef __MONEY_SOLUTION_SOLUTION_TRAINER_CLIENT_LOCAL_EXCEPTION_H__
#define __MONEY_SOLUTION_SOLUTION_TRAINER_CLIENT_LOCAL_EXCEPTION_H__
...
namespace solution_trainer_client
{
    ...
    void throw_error_code(local_exception_t err, std::string_view msg)
    {
        switch (err)
        {
            ...
            case SOLUTION_TRAINING_IN_PROGRESS_ERROR_CODE:
            {
