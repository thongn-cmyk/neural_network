...
class TestWorker: public virtual dg_sock::network_concurrency::WorkerInterface
{
    private:
        ...
        dg_sock::network_kernel_mailbox_impl1::core::MailboxInterface * sock;
        std::binary_semaphore * smp;

    public:

        TestWorker(dg_sock::network_kernel_mailbox_impl1::core::MailboxInterface * sock,
...
class Ignitor: public virtual dg_sock::network_concurrency::WorkerInterface
{
    public:
        ...
        bool run_one_epoch() noexcept
        {
...

            {
                ...
                std::cout << "initializing sock ... sock can only be initialized by main" << std::endl;
                ...
                std::cout  << "initializing sock ... sock can only be initialized by main" << std::endl;
                auto sock2 = dg_sock::network_kernel_mailbox_impl1_flash_stream_x::spawn2(dg_sock::network_kernel_mailbox_impl1_flash_stream_x::Config
                {
...
{
    {
        ...
        dg_sock::network_concurrency::daemon_register(dg_sock::network_concurrency::MAILBOX_STREAM_DAEMON, std::make_unique<Ignitor>());
