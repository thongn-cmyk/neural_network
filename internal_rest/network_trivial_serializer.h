...
namespace dg_sock::network_trivial_serializer::types{
...
namespace dg_sock::network_trivial_serializer::utility{
...
namespace dg_sock::network_trivial_serializer::archive{
...
namespace dg_sock::network_trivial_serializer{
    ...
    constexpr auto reflectible_is_equal(const T& lhs, const T& rhs) noexcept -> bool{
        ...
        constexpr size_t REFLECTIBLE_SZ = dg_sock::network_trivial_serializer::size(T{});

        std::array<char, REFLECTIBLE_SZ> lhs_byte_representation{};
        std::array<char, REFLECTIBLE_SZ> rhs_byte_representation{};

        dg_sock::network_trivial_serializer::serialize_into(lhs_byte_representation.data(), lhs);
        dg_sock::network_trivial_serializer::serialize_into(rhs_byte_representation.data(), rhs);
