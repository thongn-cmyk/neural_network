...
namespace dg_sock::network_compact_serializer::network_trivial_serializer::constants{

    static constexpr auto endianness = std::endian::little;
}

namespace dg_sock::network_compact_serializer::network_trivial_serializer::types{

    using size_type = uint64_t;
    using variant_idx_t = uint8_t;
}

namespace dg_sock::network_compact_serializer::network_trivial_serializer::types_space{
...
namespace dg_sock::network_compact_serializer::network_trivial_serializer::utility{

    using namespace dg_sock::network_compact_serializer::network_trivial_serializer::types;
    ...
    struct SyncedEndiannessService{
        ...
        static constexpr auto deflt              = dg_sock::network_compact_serializer::network_trivial_serializer::constants::endianness; 
...
namespace dg_sock::network_compact_serializer::network_trivial_serializer::archive{
...
namespace dg_sock::network_compact_serializer::network_trivial_serializer{
    ...
    constexpr auto size(T&& obj) noexcept -> size_t{
        ...
        return dg_sock::network_compact_serializer::network_trivial_serializer::archive::Counter{}.count(std::forward<T>(obj));
    }

    template <class T>
    constexpr auto serialize_into(char * buf, const T& obj) noexcept -> char *{

        dg_sock::network_compact_serializer::network_trivial_serializer::archive::Forward().put(buf, obj);
        return buf;
    }
    ...
    constexpr auto deserialize_into(T& obj, const char * buf) noexcept -> const char *{
        ...
        dg_sock::network_compact_serializer::network_trivial_serializer::archive::Backward().put(buf, obj);
        return buf;
    }
}

namespace dg_sock::network_compact_serializer::types{
...
namespace dg_sock::network_compact_serializer::constants{
...
namespace dg_sock::network_compact_serializer::exception_space{
...
namespace dg_sock::network_compact_serializer::types_space{
...
namespace dg_sock::network_compact_serializer::utility{
    ...
    static constexpr auto murmur_hash_base(const char * buf, size_t len, const uint32_t seed = 0xFF) -> std::pair<uint64_t, uint64_t>{
        ...
        {   
            ...
            dg_sock::network_compact_serializer::network_trivial_serializer::deserialize_into(k1, buf + (i * 2 + 0) * sizeof(uint64_t));
            dg_sock::network_compact_serializer::network_trivial_serializer::deserialize_into(k2, buf + (i * 2 + 1) * sizeof(uint64_t));
...
namespace dg_sock::network_compact_serializer::archive{
    ...
    struct Backward{
        ...
        constexpr void put(const char *& buf, T&& data) const{
            ...
            if constexpr(dg_sock::network_compact_serializer::constants::DESERIALIZATION_HAS_CLEAR_CONTAINER_RIGHT){
                data.clear();
            }

            // data.reserve(sz);
            dg_sock::network_compact_serializer::utility::loose_reserve_if_possible(data, sz);
    ...
    struct SafeBackward{
        ...
        constexpr void put(const char *& buf, size_t& buf_sz, T&& data) const{
            ...
            if (buf_sz < sizeof(base_type)){
                throw dg_sock::network_compact_serializer::exception_space::corrupted_format();
            }
        ...
        constexpr void put(const char *& buf, size_t& buf_sz, T&& data) const{
            ...
            // data.reserve(sz);
            dg_sock::network_compact_serializer::utility::reserve_if_possible(data, sz);
    ...
    struct DgStdForward{
        ...
        constexpr void put(char *& buf, T&& data) const{
            ...
            this->put(buf, get_dgstd_serialization_header<base_type>());
            this->put(buf, dg_sock::network_compact_serializer::utility::safe_integer_cast<container_size_type>(container.size()));
    ...
    struct DgStdBackward{
        ...
        constexpr void put(const char *& buf, size_t& buf_sz, T&& data) const{
            ...
            dg_sock::network_compact_serializer::utility::reserve_if_possible(container, sz);
...
namespace dg_sock::network_compact_serializer{
    ...
    constexpr auto wrap_container(T&& container) noexcept -> dg_sock::network_compact_serializer::types_space::ContainerWrapper<T, SizeType>{

        return dg_sock::network_compact_serializer::types_space::ContainerWrapper<T, SizeType>(std::forward<T>(container));
    }

    template <class T>
    constexpr auto size(const T& obj) -> size_t{

        return dg_sock::network_compact_serializer::archive::Counter{}.count(obj);
    }

    template <class T>
    constexpr auto serialize_into(char * buf, const T& obj) -> char *{

        dg_sock::network_compact_serializer::archive::Forward{}.put(buf, obj);
        return buf;
    } 
    ...
    constexpr auto deserialize_into(T& obj, const char * buf) -> const char *{
        ...
        dg_sock::network_compact_serializer::archive::Backward{}.put(buf, obj);
        return buf;
    }
    ...
    constexpr auto integrity_serialize_into(char * buf, const T& obj, uint32_t secret = 0u) -> char *{ 
        ...
        char * first                = buf;
        char * last                 = dg_sock::network_compact_serializer::serialize_into(first, obj);
        types::hash_type hashed     = dg_sock::network_compact_serializer::utility::hash(first, std::distance(first, last), secret);
        char * llast                = dg_sock::network_compact_serializer::serialize_into(last, hashed);
    ...
    constexpr void integrity_deserialize_into(T& obj, const char * buf, size_t sz, uint32_t secret = 0u){
        ...
        if (sz < dg_sock::network_compact_serializer::size(types::hash_type{})){
            throw dg_sock::network_compact_serializer::exception_space::corrupted_format();
        }

        size_t content_sz           = sz - dg_sock::network_compact_serializer::size(types::hash_type{});
        const char * first          = buf;
        const char * last           = std::next(first, content_sz);
        types::hash_type expecting  = {};
        types::hash_type reality    = dg_sock::network_compact_serializer::utility::hash(first, content_sz, secret);

        dg_sock::network_compact_serializer::deserialize_into(expecting, last);
...

        {
            ...
            dg_sock::network_compact_serializer::archive::SafeBackward{}.put(iterating_ptr, deserializing_sz, obj);
    ...
    constexpr auto capintegrity_size(const T& obj) -> size_t{
        ...
        return dg_sock::network_compact_serializer::size(uint64_t{}) + dg_sock::network_compact_serializer::integrity_size(obj);
    }

    template <class T>
    constexpr auto capintegrity_serialize_into(char * buf, const T& obj, uint32_t secret = 0u) -> char *{

        char * first    = std::next(buf, dg_sock::network_compact_serializer::size(uint64_t{}));
        char * last     = dg_sock::network_compact_serializer::integrity_serialize_into(first, obj, secret);
        uint64_t sz     = std::distance(first, last);
        dg_sock::network_compact_serializer::serialize_into(buf, sz); 
    ...
    constexpr auto capintegrity_deserialize_into(T& obj, const char * buf, size_t sz, uint32_t secret = 0u) -> const char *{
        ...
        if (sz < dg_sock::network_compact_serializer::size(uint64_t{})){
            throw dg_sock::network_compact_serializer::exception_space::corrupted_format();
        }

        uint64_t obj_sz     = {};
        const char * first  = dg_sock::network_compact_serializer::deserialize_into(obj_sz, buf);
        ...
        dg_sock::network_compact_serializer::integrity_deserialize_into(obj, first, obj_sz, secret);
    ...
    constexpr auto dgstd_size(const T& obj) -> size_t{
        ...
        return dg_sock::network_compact_serializer::archive::DgStdCounter{}.count(obj) + network_compact_serializer::size(types::hash_type{}) + network_compact_serializer::size(types::version_control_t{});
    }
    ...
    constexpr auto dgstd_serialize_into(char * buf, const T& obj, uint32_t secret = 0u) -> char *{
        ...
        char * first                = buf;
        char * last                 = first;
        dg_sock::network_compact_serializer::archive::DgStdForward{}.put(last, obj);
        types::hash_type hashed     = dg_sock::network_compact_serializer::utility::hash(first, std::distance(first, last), secret);
        char * llast                = dg_sock::network_compact_serializer::serialize_into(last, hashed);
        char * lllast               = dg_sock::network_compact_serializer::serialize_into(llast, dg_sock::network_compact_serializer::constants::SERIALIZATION_VERSION_CONTROL); 
    ...
    constexpr void dgstd_deserialize_into(T& obj, const char * buf, size_t sz, uint32_t secret = 0u){
        ...
        if (sz < dg_sock::network_compact_serializer::size(types::hash_type{}) + dg_sock::network_compact_serializer::size(types::version_control_t{})){
            throw dg_sock::network_compact_serializer::exception_space::corrupted_format();
        }

        size_t content_sz                       = sz - (dg_sock::network_compact_serializer::size(types::hash_type{}) + dg_sock::network_compact_serializer::size(types::version_control_t{}));
        ...
        types::hash_type reality_value          = dg_sock::network_compact_serializer::utility::hash(content_first, content_sz, secret);

        const char * version_control_first      = dg_sock::network_compact_serializer::deserialize_into(expecting_value, hash_first);
        types::version_control_t cur_ver        = {};
        types::version_control_t expected_ver   = constants::SERIALIZATION_VERSION_CONTROL;

        dg_sock::network_compact_serializer::deserialize_into(cur_ver, version_control_first);

        if (cur_ver != expected_ver){
            throw dg_sock::network_compact_serializer::exception_space::bad_version_control();
        }
...

        {
            ...
            size_t deserializing_sz     = content_sz;
            dg_sock::network_compact_serializer::archive::DgStdBackward{}.put(iterating_ptr, deserializing_sz, obj);
    ...
    constexpr auto serialize(const T& obj) -> Stream{
        ...
        Stream stream{};
        stream.resize(dg_sock::network_compact_serializer::size(obj));
        dg_sock::network_compact_serializer::serialize_into(stream.data(), obj);
    ...
    constexpr auto deserialize(const Stream& stream) -> T{
        ...
        T rs;
        dg_sock::network_compact_serializer::deserialize_into(rs, stream.data());
    ...
    constexpr auto integrity_serialize(const T& obj, uint32_t secret = 0u) -> Stream{
        ...
        Stream stream{};
        stream.resize(dg_sock::network_compact_serializer::integrity_size(obj));
        dg_sock::network_compact_serializer::integrity_serialize_into(stream.data(), obj, secret);
    ...
    constexpr auto integrity_deserialize(const Stream& stream, uint32_t secret = 0u) -> T{
        ...
        T rs;
        dg_sock::network_compact_serializer::integrity_deserialize_into(rs, stream.data(), stream.size(), secret);
    ...
    constexpr auto dgstd_serialize(const T& obj, uint32_t secret = 0u) -> Stream{
        ...
        Stream stream{};
        stream.resize(dg_sock::network_compact_serializer::dgstd_size(obj));
        dg_sock::network_compact_serializer::dgstd_serialize_into(stream.data(), obj, secret);
    ...
    constexpr auto dgstd_deserialize(const Stream& stream, uint32_t secret = 0u) -> T{
        ...
        T rs;
        dg_sock::network_compact_serializer::dgstd_deserialize_into(rs, stream.data(), stream.size(), secret);
