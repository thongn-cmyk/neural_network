#include <cuda_matrix/space_operation.h>
#include <stdio.h>
#include "assert.h"
...
{
    float x = 10.0f;
    float result = cuda_matrix::space_operation::radian_normalize(x);
}
...
__global__ void test_restrict_scalar_mul_array()
{
    ...
    cuda_matrix::space_operation::restrict_scalar_mul_array(arg_arr, 5, c, output_arr);
...
__global__ void test_restrict_scalar_div_array()
{
    ...
    cuda_matrix::space_operation::restrict_scalar_div_array(arg_arr, 5, c, output_arr);
...
__global__ void test_restrict_add_array()
{
    ...
    cuda_matrix::space_operation::restrict_add_array(lhs_arr, rhs_arr, 5, output_arr);
...
__global__ void test_restrict_multidimensional_oval_to_euclidean_array()
{
    ...
    cuda_matrix::space_operation::restrict_multidimensional_oval_to_euclidean_array(radian_arr, 3, radius_arr, output_arr);
}
...
__global__ void test_dot_product()
{
    ...
    float result = cuda_matrix::space_operation::dot_product(lhs_arr, rhs_arr, 5);
...
__global__ void test_coordinate_distance()
{
    ...
    float result = cuda_matrix::space_operation::coordinate_distance(coor_arr, 5);
...
__global__ void test_cosine_score()
{
    ...
    float result = cuda_matrix::space_operation::cosine_score(coor_arr_1, coor_arr_2, 5);
}
...
__global__ void test_cosine_angle()
{
    ...
    float result = cuda_matrix::space_operation::cosine_angle(coor_arr_1, coor_arr_2, 5);
...
__global__ void test_euclidean_to_radian_coordinate()
{
    ...
    cuda_matrix::space_operation::euclidean_to_radian_coordinate(euclid_coor_arr, 3, radian_coor_arr);
}

__global__ void test_radian_normalize_and_euclidean_to_radian_coordinate()
{
    float x = 10.0f;
    float radian_result = cuda_matrix::space_operation::radian_normalize(x);
